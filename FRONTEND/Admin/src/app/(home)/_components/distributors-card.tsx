...
export function DistributorsCard() {
  ...
  const distributorKey = `${timeFrame}_top_5_distributors` as const;
  const distributors = data?.[distributorKey] || [];
          ...
          <thead>
            <tr className="bg-blue-100 dark:bg-blue-900">
              <th className="px-4 py-3 text-left">
                <span className="text-sm text-black-100 dark:text-blue-100">
                  Name
                </span>
              </th>
            ...
            {distributors.map((distributor) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-center">
                    <span className="inline-block rounded-full bg-blue-100 px-2 py-1 text-xs text-blue-700 dark:bg-blue-900 dark:text-blue-200">
