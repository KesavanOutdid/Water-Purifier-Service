...
export default function AddInstallationTask() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      Swal.fire("Success", "Installation task created successfully", "success");
      router.push("/management/installation");
    } catch (error) {
      console.error("Failed to create installation task:", error);
      const errorMessage =
        error instanceof Error ? error.message : "Failed to create installation task";
